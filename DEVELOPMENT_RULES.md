# HANDBALL ANALYTICS - DEVELOPMENT RULES
...
3. Oppdater ARCHITECTURE.md hvis nødvendig
...
1. Les ARCHITECTURE.md (30 min)
2. Les DEVELOPMENT_RULES.md (denne filen) (20 min)
3. Les TEST_GUIDE.md (15 min)
4. Les SECURITY_RULES.md (20 min)
...
- **SECURITY_RULES.md** - Security, authentication, and validation rules

  ...
  document.addEventListener('click', (e) => {
    ...
    switch (action) {
      ...
      case 'selectShotPosition':
        ...
        break;
      case 'selectAssist':
        selectAssist(parseInt(button.dataset.playerId), closeModal, updateGoalVisualization, () =>
          updateStatisticsOnly(renderStatistics, () => {})
        );
        break;
      case 'skipAssist':
        skipAssist(closeModal, updateGoalVisualization, () =>
          updateStatisticsOnly(renderStatistics, () => {})
        );
        break;
      case 'registerShot':
        registerShot(parseInt(button.dataset.playerId), closeModal, updateGoalVisualization, () =>
          updateStatisticsOnly(renderStatistics, () => {})
        );
        break;
      case 'closeShotPopup':

...
import {
  saveCompletedMatchToFirestore,
  deleteCompletedMatchFromFirestore,
...
export async function finishMatch() {
  ...
  const hasGoalsOrSaves = secondHalfEvents.some(
    (e) => e.result === 'mål' || e.result === 'redning'
  );
